...
class MapPage extends StatefulWidget {
  ...
  // Explicitly tells the map which detail screen to open.
  // This avoids relying only on showAllReports to determine
...
class _MapPageState extends State<MapPage> {
  ...
  Stream<List<WasteReport>> _getReportStream() {
    ...
    return _firestoreService.getUserReports(
      user.uid,
    );
  }

  String get _pageTitle {
    return widget.showAllReports
        ? 'Community Map'
        : 'My Report Map';
  }

  List<WasteReport> _filteredReports(
  ...
  Future<void> _goToUserCurrentLocation() async {
    try {
      ...
      debugPrint(
        'Could not get live location: $e',
      );
    }
  }

  Set<Marker> _buildMarkers(
    List<WasteReport> filteredReports,
  ) {
  ...
  Widget _buildHorizontalReportCard(
